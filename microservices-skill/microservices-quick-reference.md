...
- Full Skill Guide: `microservices-skill/microservices-quick-reference.md`
- Implementation Guide: see the implementation examples and guidance in this document
